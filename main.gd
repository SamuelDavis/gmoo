...
const MAIN_MENU_SCREEN: PackedScene = preload("res://main_menu_screen.tscn")
const GAME_CONFIGURATION_SCREEN: PackedScene = preload("res://game_configuration_screen.tscn")
const RACE_SELECTION_SCREEN: PackedScene = preload("res://race_selection_screen.tscn")
